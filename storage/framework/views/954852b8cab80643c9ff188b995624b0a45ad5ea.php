            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <!-- First Name -->
                        <div class="row mb-3">
                            <label for="firstName" class="col-md-4 col-form-label text-md-end"><?php echo e(__('First Name')); ?></label>
                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" name="address" rows="3" required><?php echo e(old('address')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CourseTools\Laragon\laragon\www\BTPR2\resources\views/auth/register.blade.php ENDPATH**/ ?>